...
const ShoppingCart = () => {
    ...
    const [profileClass, setProfileClass] = useState(
        "border-gray-200 dark:bg-gray-100 dark:border-gray-200",
    );
    const apolloClient = useApolloClient();

    const [addressSelected, setAddressSelected] = useState(false);
    const [payButtonColor, setPayButtonColor] = useState(
        "bg-gray-500 border-gray-600 ring-gray-500",
    );
    ...
    const [
        getTemporaryInvoice,
        { data: temporaryInvoiceData, called: temporaryInvoiceCalled },
    ] = useLazyQuery(GET_INVOICE_BY_RESERVATION_ID);
    ...
    if (loading)
        return (
            <p className="text-center p-10">Chargement du panier en cours...</p>
        );
    ...
    if (userId && data?.getCartReservationOfUser) {
        ...
        if (temporaryInvoiceData?.getInvoiceByIdReservation?.UserBilling) {
            userBilling.id =
                temporaryInvoiceData.getInvoiceByIdReservation.UserBilling.id;
            userBilling.firstname =
                temporaryInvoiceData.getInvoiceByIdReservation.UserBilling.firstname;
            userBilling.lastname =
                temporaryInvoiceData.getInvoiceByIdReservation.UserBilling.lastname;
            userBilling.street =
                temporaryInvoiceData.getInvoiceByIdReservation.UserBilling.street;
            userBilling.postal_code =
                temporaryInvoiceData.getInvoiceByIdReservation.UserBilling.postal_code;
            // userBilling.city = temporaryInvoiceData.getInvoiceByIdReservation.UserBilling.city;
            userBilling.country =
                temporaryInvoiceData.getInvoiceByIdReservation.UserBilling.country;
        }
    ...
    if (userData) {
        ...
        userBilling.firstname =
            userBilling.firstname || userProfile.firstname || "";
        userBilling.lastname =
            userBilling.lastname || userProfile.lastname || "";
        userBilling.postal_code =
            userBilling.postal_code || userProfile.postal_code || "";
    ...
    const submitCart = async () => {
        if (cartId) {
            ...
            if (userBilling.id?.length === 0) {
                ...
                if (newInvoice.data) {
                    userBilling.id =
                        newInvoice.data.createInvoice.UserBilling.id;
                } else {
                    toast.error(
                        "Erreur : Un problème est survenu lors de l'enregistrement de vos données de facturation.",
                    );
                    return;
                }
            }
            ...
            try {
                ...
                return navigate("/cart/checkout-confirmation", {
                    state: {
                ...
                toast.error(
                    "Erreur : La réservation n'a pas pu être confirmée.",
                );
            }
        }
    };
                ...
                <div className="w-full absolute z-10 h-full overflow-x-hidden">
                    <div className="flex md:flex-row flex-col">
                        ...
                        >
                            ...
                            {products && data?.getCartReservationOfUser ? (
                                // Cart with products
                                [
                                    ...
                                    products.map(
                                        (product: any) => (
                                            ...
                                            (reservation_start_at =
                                                reservation_start_at >
                                                product.start_at.getTime()
                                                    ? product.start_at.getTime()
                                                    : reservation_start_at),
                                            (reservation_end_at =
                                                reservation_end_at <
                                                product.end_at.getTime()
                                                    ? product.end_at.getTime()
                                                    : reservation_end_at),
                                            (
                                                <div className="lg:flex items-center py-4 border-t border-gray-200">
                                                    {/* Product name (mobile) */}
                                                    <p className="block lg:hidden text-base text-center font-black text-blue-800 pb-2">
                                                        {product.name}
                                                    </p>
                                                    ...
                                                    <div className="basis-1/5 lg:basis-1/6 relative mx-auto lg:mx-0 pb-2 md:pb-0 overflow-hidden rounded-md border border-b-0 lg:border-b border-gray-200 shadow-md lg:shadow-none">
                                                        <img
                                                            ...
                                                            alt={product.name}
                                                            className="w-24 h-24 object-center object-cover mx-auto"
                                                        />
                                                    ...
                                                    <div className="basis-1/5 lg:basis-1/6 relative visible lg:hidden mx-auto p-2 text-center lg:mx-0 mt-[-0.2rem] overflow-hidden rounded-md rounded-t-none border border-t-0 border-gray-200 bg-gray-200 shadow-md lg:shadow-none">
                                                        <p className="text-sm text-gray-600 leading-5">
                                                            Location du{" "}
                                                            {product.start_at.toLocaleDateString(
                                                                "fr-FR",
                                                            )}{" "}
                                                            au{" "}
                                                            {product.end_at.toLocaleDateString(
                                                                "fr-FR",
                                                            )}{" "}
                                                            ({product.duration}{" "}
                                                            jours)
                                                    ...
                                                    <div className="basis-4/5 lg:basis-3/6 hidden lg:block text-center lg:text-left mt-5 lg:mt-0 ml-0 lg:ml-5 leading-none">
                                                        <p className="text-base font-black text-gray-800 pb-2">
                                                            {product.name}
                                                        </p>
                                                    ...
                                                    <div className="basis-full lg:basis-2/6 sm:grow hidden lg:block ml-10">
                                                        ...
                                                        <div className="pt-10">
                                                            <p className="text-base text-right font-black leading-none text-gray-600">
                                                                Sous-total
                                                                produit:{" "}
                                                                {
                                                                    product.subtotal
                                    ...
                                    <div className="sm:flex-iniital md:flex justify-between mt-5 mb-20">
                                        ...
                                        <div className="sm:w-full md:w-1/2">
                                            ...
                                            <div
                                                className={
                                                    "w-full max-w-sm items-center mt-3 border rounded-lg shadow" +
                                                    profileClass
                                                }
                                            >
                                                        ...
                                                        <>
                                                            ...
                                                            <div className="flex mt-4 space-x-3 md:mt-6">
                                                                ...
                                                                <button
                                                                    onClick={() => {
                                                                        setProfileClass(
                                                                            "border-orange-500 ring-4 ring-orange-500 bg-gray-100 dark:border-orange-500",
                                                                        );
                                                                        setAddressSelected(
                                                                            true,
                                                                        );
                                                                        ...
                                                                        setPayButtonColor(
                                                                            "bg-orange-500 border-orange-600 ring-orange-500",
                                                                        );
                                                                    }}
                                        ...
                                        <div className="sm:w-full md:w-1/2">
                                            ...
                                            <div
                                                className={
                                                    "w-full max-w-sm items-center mr-0 mt-3 border rounded-lg shadow" +
                                                    profileClass
                                                }
                                            >
                                                <div className="flex flex-col items-center text-center p-5 text-sm text-gray-600">
                                                    <h5 className="mb-1 text-xl font-medium text-gray-800">
                                                        Wildrent Pickup Location
                                                    </h5>
                                                    <span>
                                ...
                                <div className="flex items-stretch sm:w-full w-auto lg:h-full">
                                    <div className="self-center w-full max-w-lg mx-auto text-center p-10 lg:mt-[-6rem] mt-0 bg-white border border-gray-300 rounded-lg shadow-lg">
                                        ...
                                        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900">
                                            Oups,
                                            <br /> Votre panier de réservation
                                            est vide
                                        </h5>
                                        <p className="mb-3 font-normal text-gray-700">
                                            Et si vous commenciez une nouvelle
                                            réservation ?
                                        </p>
                                        <Link
                        ...
                        <div className="md:w-1/2 lg:w-1/4 w-full bg-gray-100 shadow-sm h-full sm:relative lg:fixed lg:bottom-0 lg:right-0 lg:top-0">
                            <div className="flex flex-col md:h-full p-10 pb-24 justify-between overflow-y-hidden">
                                <div>
                                    <p className="text-2xl text-center font-black leading-9 text-gray-800">
                                        Détails du paiement
                                    </p>
                                ...
                                addressSelected === false ? (
                                    <div>
                                        <p className="text-center text-red-500 sm:pt-5 pt-0">
                                            Vous devez selectionner une adresse
                                            de facturation pour pouvoir payer
                                        </p>
                                    </div>
                                ) : (
                                    ""
                                ...
                                <div>
                                    <div className="flex items-center pb-6 justify-between lg:pt-5 pt-20">
                                        <p className="text-lg font-bold leading-normal text-gray-700">
                                            TOTAL TTC
                                        </p>
                                        <p className="text-lg font-bold leading-normal text-right text-blue-600">
                                            {(+tSubtotal + +totalTaxes).toFixed(
                                                2,
                                            )}{" "}
                                            €
                                        </p>
                                    ...
                                    <button
                                        ...
                                        className={
                                            "rounded-sm text-base leading-none w-full py-5 text-white ring " +
                                            payButtonColor +
                                            " ring-offset-2"
                                        }
