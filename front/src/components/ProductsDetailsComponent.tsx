                  ...
                  <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                        ...
                        <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                          ...
                          <div className="mt-2">
                            <p className="text-sm text-gray-500">
                              Vous pouvez à présent vous rendre dans votre
                              panier de produits pour confirmer votre/vos
                              réservations ou continuer vos achats.
                            </p>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="flex ps-5 pe-10 md:px-20 lg:px-24 pt-5 pb-10 text-gray-500">
                      <div className="flex-1">
                        <span className="font-semibold">Articles : </span>1
                      </div>
                      <div className="flex-1 text-right">
                        <span className="font-semibold">Total : </span> {price}{" "}
                        €
                      </div>
                    </div>
                ...
                <div className="flex items-stretch">
                  {updateToggle && (
                    <button
                      ...
                      // disabled={buttonState}
                      onClick={() =>
                        submitUpdateProduct(id, updateProductInput)
                      }
                    >
                      Envoyer
                    </button>
