...
const Product = ({ id, name, description, price, stock, picture, available }: IProductProps) => {
    ...
    return (
        <div className="grid grid-cols-5 h-full">
            ...
            <div className="col-span-2 h-full p-10 bg-white shadow-[0_4px_12px_0_rgba(0,0,0,0.07),_0_2px_4px_rgba(0,0,0,0.05)] data-[te-sidenav-hidden='false']:translate-x-0 dark:bg-zinc-800"
            ...
            >
                ...
                <span className="block mb-3 text-2xl font-bold text-white">{price} €/day</span>
                ...
                <hr className="text-gray-500" />
                    <div className="grid grid-cols-2 py-5 text-yellow-500">
                        ...
                        <div className="text-right"><span className="font-bold">Stock :</span> {stock}</div>
                    </div>
                <hr />
                <a href="#" className="inline-flex absolute bottom-10 items-center justify-center px-5 py-3 text-base font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                    Add To Cart
